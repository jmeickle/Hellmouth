...
def main(stdscr):
    ...
    from views.tactical import MainMap, Pane, Stats, Status, Log, View
    from levels.meat.screens import StartScreen
    from levels.chargen.chargen import Chargen
...
#            exit("COWARD.")
    ...
    pc.location = "A strange, meaty arena"
    ...
    screen.player = pc
    help = HelpScreen(stdscr, TERM_X, TERM_Y)
    help.player = pc
